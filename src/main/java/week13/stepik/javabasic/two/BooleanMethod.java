...
public class BooleanMethod {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("fftt " + fftt + " <- must be a true");

        System.out.println("ftff " + ftff);
        System.out.println("ftft " + ftft + " <- must be a true");
        System.out.println("fttf " + fttf + " <- must be a true");
        System.out.println("fttt " + fttt);

        System.out.println("tfff " + tfff);
        System.out.println("tfft " + tfft + " <- must be a true");
        System.out.println("tftf " + tftf + " <- must be a true");
        System.out.println("tftt " + tftt);

        System.out.println("ttff " + ttff + " <- must be a true");
